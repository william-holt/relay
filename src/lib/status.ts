...
export const STATUS_META: Record<CustomerStatus, StatusMeta> = {
  cold_lead: { value: "cold_lead", label: "Cold lead", color: "#64748b", pipeline: false, won: false },
  hot_lead: { value: "hot_lead", label: "Hot lead", color: "#f59e0b", pipeline: false, won: false },
  outreach: { value: "outreach", label: "Outreach", color: "#0ea5e9", pipeline: true, won: false },
  contacted: { value: "contacted", label: "Contacted", color: "#8b5cf6", pipeline: true, won: false },
  in_pipeline: { value: "in_pipeline", label: "In pipeline", color: "#6366f1", pipeline: true, won: false },
  sold: { value: "sold", label: "Sold", color: "#10b981", pipeline: false, won: true },
  recurring: { value: "recurring", label: "Recurring", color: "#0d9488", pipeline: false, won: true },
  lost: { value: "lost", label: "Lost", color: "#9ca3af", pipeline: false, won: false },
};
